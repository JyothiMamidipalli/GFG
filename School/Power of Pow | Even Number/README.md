<h2><a href="https://practice.geeksforgeeks.org/problems/power-of-pow-even-number5440/1?page=1&difficulty[]=-2&category[]=Mathematical&sortBy=latest">Power of Pow | Even Number</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a single integer <strong>N</strong>, your task is to find the sum of the square of the first <strong>N even natural Numbers</strong>.</span><br>
&nbsp;</p>
