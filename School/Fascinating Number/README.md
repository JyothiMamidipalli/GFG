<h2><a href="https://practice.geeksforgeeks.org/problems/fascinating-number3751/1?page=3&difficulty=School&sortBy=submissions">Fascinating Number</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>. Your task is to check whether it is fascinating or not.<br>
